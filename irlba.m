...
while (iter <= maxit)
    ...
    [conv,U_B,S_B,V_B,K] = convtests(Bsz,disps,tol,K_org,U_B,S_B,V_B,abs(R),iter,K,SVTol,Smax,mprod);
...
function [conv,U_B,S_B,V_B,K] = convtests(Bsz,disps,tol,K_org,U_B,S_B,V_B,residuals,iter,K,SVTol,Smax,mprod)
